...
secondary: "dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white light:bg-gray-200 light:hover:bg-gray-300 light:text-black border dark:border-gray-600 light:border-gray-300 dark:hover:border-gray-500 light:hover:border-gray-400",
